...
const MyBookings = () => {
  ...
  return (
    <div className='py-28 md:pb-35 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32'>
        <Title title='My Bookings' subTitle="Easily manage your past, current, and upcoming hotel reservation is one place. Plan your trips seamlessly with just a few clicks " align="left"/>
        ...
        <div className='max-w-6xl mt-8 w-full text-gray-800'>
            ...
            <div key={bookings._id} className='grid grid-cols-1 md:grid-cols-[3fr_2fr_1fr] w-full border-b border-gray-300 py-6 first:border-t'>
                ...
                <img src={bookings.room.images[0]} alt="" className='min-md:w-44 rounded shadow object-cover' />
